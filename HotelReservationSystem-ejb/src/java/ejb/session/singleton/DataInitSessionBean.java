...
public class DataInitSessionBean {
    ...
    @EJB
    private RoomSessionBeanLocal roomEntitySessionBeanLocal;
    @EJB
    ...
    public void initialiseData() {
        try {
            ...
            roomTypeSessionBeanLocal.createNewRoomType(new RoomType("Deluxe Room", "deluxe room", "Small", "Queen", "2", "drinks"));
            roomTypeSessionBeanLocal.createNewRoomType(new RoomType("Premier Room", "premier room", "Small", "Queen", "2", "drinks"));
            roomTypeSessionBeanLocal.createNewRoomType(new RoomType("Family Room", "family room", "Small", "Queen", "2", "drinks"));
            roomTypeSessionBeanLocal.createNewRoomType(new RoomType("Junior Suite", "junior room", "Small", "Queen", "2", "drinks"));
            roomTypeSessionBeanLocal.createNewRoomType(new RoomType("Grand Suite", "grand room", "Small", "Queen", "2", "drinks"));
            ...
            roomEntitySessionBeanLocal.createNewRoom(room1, 1l);
            roomEntitySessionBeanLocal.createNewRoom(room2, 2l);
            roomEntitySessionBeanLocal.createNewRoom(room3, 3l);
            roomEntitySessionBeanLocal.createNewRoom(room4, 4l);
            roomEntitySessionBeanLocal.createNewRoom(room5, 5l);
